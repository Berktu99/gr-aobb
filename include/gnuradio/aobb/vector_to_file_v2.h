...
#ifndef INCLUDED_AOBB_VECTOR_TO_FILE_V2_H
#define INCLUDED_AOBB_VECTOR_TO_FILE_V2_H
 ...
 */
class AOBB_API vector_to_file_v2 : virtual public sync_block
{
public:
    typedef std::shared_ptr<vector_to_file_v2> sptr;
...
#endif /* INCLUDED_AOBB_VECTOR_TO_FILE_V2_H */
